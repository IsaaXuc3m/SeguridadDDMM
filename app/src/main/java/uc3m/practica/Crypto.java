...
public class Crypto {
    ...
    private static int ITERATION_COUNT = 10000;// cambiado a 10k
    ...
    public static byte[] generateIv(int length) {// usualmente tiene el mismo tamano que el bloque de clave.
    ...
    public static byte[] generateSalt() {// tamano de la clave para nosotros es de 256 bit, 32 bytes.
